...
import 'package:moodtunes/authentication/signupscreen.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(child: Text('Welcome to Moodtunes Music',style: TextStyle(color: Color(0xff08979C),fontSize: 20,fontWeight: FontWeight.bold),)),
              SizedBox(
              height: 10,
            ),
              Center(child: Text('Create Your account',style: TextStyle(color: Color(0xffffffff),fontSize: 20,fontWeight: FontWeight.bold),)),
             SizedBox(
                height: 25,
              ),
            ...
            Row(
              ...
              children: [
                ...
                MaterialButton(
                child: Text('Signin',style: TextStyle(color: Color(0xff24CEF0))),
                onPressed: () {
